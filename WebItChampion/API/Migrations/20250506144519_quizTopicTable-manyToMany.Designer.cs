...
namespace API.Migrations
{
    ...
    [Migration("20250506144519_quizTopicTable-manyToMany")]
    partial class quizTopicTablemanyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Leaderboard", b =>
                {
                    ...
                    b.HasIndex("Period", "PeriodStart", "Score");

                    b.HasIndex("Period", "UserID", "PeriodStart");
            ...
            modelBuilder.Entity("API.Models.QuizTopic", b =>
                {
                    b.Property<string>("QuizTopicID")
