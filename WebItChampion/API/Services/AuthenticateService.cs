...
namespace API.Services
{
    ...
    public class AuthenticateService : IAuthenticateService
    {
        ...
        public AuthenticateService(IMapper mapper, Sep490Context context, JwtAuthentication jwtAuthen)
        {
            _mapper = mapper;
            _context = context;
        ...
        {
            string msg = "";
            var user = await _context.Users.FirstOrDefaultAsync(x => x.Email == userLogin.Username || x.Username == userLogin.Username);
