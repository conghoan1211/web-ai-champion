...
namespace API.Services
{
    ...
    public class ProfileService : IProfileService
    {
        ...
        public ProfileService(IMapper mapper, Sep490Context context, JwtAuthentication jwtAuthen, IAmazonS3Service s3Service)
        {
            _context = context;
        ...
        {
            if (userID == null || updatedProfile == null ) return "Invalid profile data or userId is null";
            var user = await _context.Users.FirstOrDefaultAsync(x => x.UserId == userID);
