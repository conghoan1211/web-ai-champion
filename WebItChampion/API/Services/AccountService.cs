...
namespace API.Services
{
    public interface IAccountService
    {
        ...
        public Task<string> EditRoleAndActive(string userId, int roleId, bool isActive);
    ...
    public class AccountService : IAccountService
    {
        ...
        public AccountService(IMapper mapper, Sep490Context context, IAmazonS3Service s3Service)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<string> EditRoleAndActive(string userId, int roleId, bool isActive)
        {
            if (userId.IsEmpty()) return "User ID is not valid!";
