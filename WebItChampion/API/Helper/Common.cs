...
namespace API.Helper
{
    public static class Common
    {
        ...
        public static string CheckUsername(this IQueryable<User> query, string username)
        {
            bool check = query.Any(u => u.Username == username);
            if (check) return "Username này đã tồn tại.";
